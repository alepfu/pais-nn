...
Usage:
    conda activate paisnn_env
    python pais-nn.py -m pais.pth -s <site-dir> -e <ecosystem-distribution.csv>
...
Arguments:
    ...
    -e, --ecosysdists   Path to the CSV file containing ecosystem distribution priors. (required)
...
def setup_parser():
    ...
    parser.add_argument('-e', '--ecosysdists', required=True, help='Ecosystem distribution CSV-file (mandatory)')
